...
class Quote{
    ...
    function createQuote($data){
        ...
        `timberType`,`timberSize`,`timberPrice`,`timberArea`,`timberWastage`,`timberTotal`,
        `underlayPrice`,`underlayArea`,`underlayTotal`,
        `carpetRemovalPrice`,`carpetRemovalArea`,`carpetRemovalTotal`,
        `furnitureRemovalPrice`,`furnitureRemovalQuantity`,`furnitureRemovalTotal`,
        `floorLevelingPrice`,`floorLevelingArea`,`floorLevelingTotal`,
        `installChoice`,`skirtingChoice`,`skirtingPrice`,`skirtingLength`,`skirtingTotal`,
        `deliveryFeeTotal`,
        `atColor`,`atPrice`,`atLength`,`atTotal`,
        ...
        '{$data['timberType']}','{$data['timberSize']}','{$data['timberPrice']}','{$data['timberArea']}','{$data['timberWastage']}','{$data['timberTotal']}',
        '{$data['underlayPrice']}','{$data['underlayArea']}','{$data['underlayTotal']}',
        '{$data['carpetRemovalPrice']}','{$data['carpetRemovalArea']}','{$data['carpetRemovalTotal']}',
        '{$data['furnitureRemovalPrice']}','{$data['furnitureRemovalQuantity']}','{$data['furnitureRemovalTotal']}',
        '{$data['floorLevelingPrice']}','{$data['floorLevelingArea']}','{$data['floorLevelingTotal']}',
        '{$data['installChoice']}','{$data['skirtingChoice']}','{$data['skirtingPrice']}','{$data['skirtingLength']}','{$data['skirtingTotal']}',
        '{$data['deliveryFeeTotal']}',
        '{$data['atColor']}','{$data['atPrice']}','{$data['atLength']}','{$data['atTotal']}',
