            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-3 input-group">
                        ...
                        <input id="popupFinalTotalPrice" name="popupFinalTotalPrice" type="number" class="input-lg form-control" />
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-2 input-group input-group-sm">
                        <span class="input-group-addon">$</span>
                        <input id="reduceFinalTotalPrice" name="reduceFinalTotalPrice" type="number" class="form-control" />
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-sm-2 control-label">Discount</label>
                    <div class="col-sm-2 input-group input-group-sm">
                        <input id="discountFinalTotalPrice" name="reduceFinalTotalPrice" type="number" class="form-control" />
